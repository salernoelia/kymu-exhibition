import { app as e, BrowserWindow as l, session as n } from "electron";
...
e.whenReady().then(() => {
  ...
  n.defaultSession.webRequest.onHeadersReceived((t, o) => {
    o({
      responseHeaders: {
        ...t.responseHeaders,
  ...
  }), e.isPackaged ? s.loadFile(i.join(__dirname, "../dist/index.html")) : s.loadURL(process.env.VITE_DEV_SERVER_URL || "http://localhost:3000");
});
